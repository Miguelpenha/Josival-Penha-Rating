...
import { Container, Title, Input, ContainerIconSettings, IconSettings } from '../styles/pages'
...
function Home() {
    ...
    return <>
        ...
        <Container>
            <ContainerIconSettings href="/settings">
                <IconSettings xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                    <g>
